...
def define_flags():
    ...
    tf.app.flags.DEFINE_integer('z_dim', 128, "Dimension of noise from which we sample")
    ...
    tf.app.flags.DEFINE_float('lbd', 10, "Hyperparam for gradient constraints")
    tf.app.flags.DEFINE_integer('ncritic', 5, "Number of critic opt run")
