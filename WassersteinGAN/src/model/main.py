...
if __name__ == "__main__":
    ...
    parser.add_argument('--clamp_upper', default=-0.01, type=float, help="Clamp weights below this value")
    parser.add_argument('--clamp_lower', default=0.01, type=float, help="Clamp weights above this value")
